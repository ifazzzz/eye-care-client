    ...
    return (
        <div>
            <footer className="px-4 divide-y bg-white text-gray-800">
                <div className="container flex flex-col justify-between py-10 mx-auto space-y-8 lg:flex-row lg:space-y-0">
                    <div className="lg:w-1/3">
                        <Link className="flex justify-center space-x-3 lg:justify-start">
                            ...
                            <span className="self-center text-2xl font-semibold">Eye-care Ltd</span>
                        </Link>
                    </div>
                ...
                <div className="py-6 text-sm text-center text-gray-600">© 2022 Company Co. All rights reserved.</div>
            </footer>
        </div>
    );
};
